    ...
    <>
      ...
      {showDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[80vh] overflow-auto shadow-xl">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="mt-2 text-gray-500">No saved resumes yet</p>
                <p className="text-sm text-gray-400">Create and save your first resume!</p>
              </div>
            ) : (
              <div className="space-y-2">
                {resumes.map((resume) => (
                  <div
                    key={resume.id}
                    className={`relative group border rounded-lg p-4 hover:bg-gray-50 transition-all cursor-pointer ${
                      resume.id === currentResumeId ? 'bg-blue-50 border-blue-300' : 'border-gray-200'
                    }`}
